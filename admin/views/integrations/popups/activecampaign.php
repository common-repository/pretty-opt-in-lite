<?php
$current_addon_data = pretty_opt_in_get_addon_data('activecampaign');
?>
<div class="pretty-box" role="document">
    ...
    <div class="pretty-box-header pretty-block-content-center">
        ...
        <div class="pretty-dialog-image" aria-hidden="true">
            ...
            <img src="<?php echo esc_url(PRETTY_OPT_IN_URL.'/assets/images/integrations/activecampaign.png'); ?>" alt="<?php esc_attr_e( 'ActiveCampaign API', 'pretty-opt-in' ); ?>">

        </div>

        <div class="pretty-box-content integration-header">

            <h3 class="pretty-box-title" id="dialogTitle2"><?php esc_html_e( 'Setup ActiveCampaign API', 'pretty-opt-in' ); ?></h3>

			<span class="pretty-description">
                <?php esc_html_e( 'Setup your ActiveCampaign API key. Grant Full Access in settings of your API Url and API Key.', 'pretty-opt-in' ); ?>
			</span>
    ...
    <div class="pretty-box-body">
        <form class="pretty-integration-form" method="post" name="pretty-integration-form" action="">
            ...
            <div class="pretty-form-field">
                <label class="pretty-label"><?php esc_html_e( 'API Url', 'pretty-opt-in' ); ?></label>
                <div class="pretty-control-with-icon">
                    <ion-icon class="pretty-icon-key" name="key"></ion-icon>
                    <input name="api_url" placeholder="<?php esc_html_e( 'API Url', 'pretty-opt-in' ); ?>" value="<?php if(!empty($current_addon_data['api_url'])){echo esc_attr( $current_addon_data['api_url'] );}?>" class="pretty-form-control">
                </div>
            </div>
            ...
            <input type="hidden" name="slug" value="<?php echo esc_attr('activecampaign');?>" >
