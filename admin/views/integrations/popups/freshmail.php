<?php
$current_addon_data = pretty_opt_in_get_addon_data('freshmail');
?>
<div class="pretty-box" role="document">
    ...
    <div class="pretty-box-header pretty-block-content-center">
        ...
        <div class="pretty-dialog-image" aria-hidden="true">
            ...
            <img src="<?php echo esc_url(PRETTY_OPT_IN_URL.'/assets/images/integrations/freshmail.png'); ?>" alt="<?php esc_attr_e( 'FreshMail API', 'pretty-opt-in' ); ?>">

        </div>

        <div class="pretty-box-content integration-header">

            <h3 class="pretty-box-title" id="dialogTitle2"><?php esc_html_e( 'Setup FreshMail API', 'pretty-opt-in' ); ?></h3>

			<span class="pretty-description">
                <?php esc_html_e( 'Setup your FreshMail API key. Grant Full Access in settings of your API key.', 'pretty-opt-in' ); ?>
			</span>
    ...
    <div class="pretty-box-body">
        <form class="pretty-integration-form" method="post" name="pretty-integration-form" action="">
            ...
            <div class="pretty-form-field">
                <label class="pretty-label"><?php esc_html_e( 'Secret Key', 'pretty-opt-in' ); ?></label>
                <div class="pretty-control-with-icon">
                    <ion-icon class="pretty-icon-key" name="key"></ion-icon>
                    <input name="api_secret" placeholder="<?php esc_html_e( 'Secret Key', 'pretty-opt-in' ); ?>" value="<?php if(!empty($current_addon_data['api_secret'])){echo esc_attr( $current_addon_data['api_secret'] );}?>" class="pretty-form-control">
                </div>
            </div>

            <input type="hidden" name="slug" value="<?php echo esc_attr('freshmail');?>" >
