<?php
$current_addon_data = pretty_opt_in_get_addon_data('mailjet');
?>
<div class="pretty-box" role="document">
    ...
    <div class="pretty-box-header pretty-block-content-center">
        ...
        <div class="pretty-dialog-image" aria-hidden="true">
            ...
            <img src="<?php echo esc_url(PRETTY_OPT_IN_URL.'/assets/images/integrations/mailjet.png'); ?>" alt="<?php esc_attr_e( 'MailJet API', 'pretty-opt-in' ); ?>">

        </div>

        <div class="pretty-box-content integration-header">

            <h3 class="pretty-box-title" id="dialogTitle2"><?php esc_html_e( 'Setup MailJet API', 'pretty-opt-in' ); ?></h3>

			<span class="pretty-description">
                <?php esc_html_e( 'Setup your MailJet API key. Grant Full Access in settings of your API key.', 'pretty-opt-in' ); ?>
			</span>
    ...
    <div class="pretty-box-body">
        <form class="pretty-integration-form" method="post" name="pretty-integration-form" action="">
            ...
            <input type="hidden" name="slug" value="<?php echo esc_attr('mailjet');?>" >
