<?php
/**
 * Pretty_Opt_In_Admin_Module Class
 *
 * @since  1.0.0
...
if ( ! class_exists( 'Pretty_Opt_In_Admin_Module' ) ) :

abstract class Pretty_Opt_In_Admin_Module {
	...
	/**
	 * Pretty_Opt_In_Admin_Module constructor.
	 *
	 * @since 1.0
	 */
