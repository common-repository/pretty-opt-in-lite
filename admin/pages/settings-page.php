<?php
/**
 * Pretty_Opt_In_Settings_Page Class
 *
 * @since  1.0.0
...
if ( ! class_exists( 'Pretty_Opt_In_Settings_Page' ) ) :

    class Pretty_Opt_In_Settings_Page extends Pretty_Opt_In_Admin_Page {
        ...
        public function enqueue_scripts( $hook ) {
            ...
            pretty_opt_in_admin_enqueue_scripts_settings(
