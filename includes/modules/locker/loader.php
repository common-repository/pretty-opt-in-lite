...
if ( ! class_exists( 'Pretty_Opt_In_Locker' ) ) :

class Pretty_Opt_In_Locker extends Pretty_Opt_In_Module {
	...
	public function load_admin() {
		if( is_admin() ) {
			...
			new Pretty_Opt_In_Locker_Admin();
		}
	}
	...
	public function register_cpt() {
		...
		register_post_type( 'pretty_opt_in_locker', $args );
	}
